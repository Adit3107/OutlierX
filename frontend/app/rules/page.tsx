...
import { RulesPageContent } from '../../components/rules/rule-console';
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background px-4 text-foreground">
      <section className="w-full max-w-sm rounded-md border border-border bg-surface p-5">
        ...
        <p className="mt-4 text-sm text-muted-foreground">Authenticate to manage deterministic fraud rules.</p>
